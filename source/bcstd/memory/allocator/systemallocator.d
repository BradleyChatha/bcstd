module bcstd.memory.allocator.systemallocator;
...
import bcstd.memory.allocator._test;
...
version(Windows)
{
    ...
    import core.sys.windows.windows : HANDLE, DWORD, SIZE_T, LPVOID, BOOL;
...
else // Default to libc for platforms without specific support.
{
    ...
    import bcstd.memory.funcs : memset;
